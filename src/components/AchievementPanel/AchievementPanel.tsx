...
export const AchievementPanel: React.FC<AchievementPanelProps> = ({ summary }) => {
  ...
  return (
    <div className="achievement-panel" style={{ minWidth: 600, background: 'linear-gradient(135deg, #23304a 0%, #2d3e5e 100%)', borderRadius: 20, padding: '36px 32px', color: '#fff', boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
      <div style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 30, letterSpacing: 2, marginBottom: 28, background: 'rgba(255,255,255,0.95)', color: '#23304a', borderRadius: 14, padding: '12px 0', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>BADGES GAINED</div>
