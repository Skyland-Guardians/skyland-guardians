...
export const AI_PERSONALITIES: AIPersonality[] = [
	{
		id: 'wise_owl',
		name: 'Wise Owl',
		avatar: '/assets/主界面1资源/右边的AI人物.png',
	...
	},
	{
		...
		name: 'Calm Panda',
		avatar: '/assets/主界面1资源/右边的AI人物.png',
		prompt: 'You are a steady panda coach who answers questions in a concise, rational way. Provide clear analysis and stable advice.',
		riskTolerance: 'low',
		feedbackTemplates: [
